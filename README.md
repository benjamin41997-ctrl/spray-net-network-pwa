...
The initial public catalog in `site/data/mailing.json` contains **62** source-reviewed records: 49 school/program locations in Fort Mill, Tega Cay and Rock Hill; two district offices; and 11 selected dental offices in Fort Mill, Rock Hill, Charlotte and Waxhaw. It is a starter list, not comprehensive coverage of the territory. Every address has its source URL and review date. School sources are the [Fort Mill directory](https://www.fortmillschools.org/about-us/our-schools-directory) and [Rock Hill directory](https://www.rock-hill.k12.sc.us/district/our-schools); dental sources are official practice pages linked per record. Existing networking companies appear as held records until structured mailing addresses are specifically researched; the app never converts a city/ZIP or visitor address into an assumed mailing address.
