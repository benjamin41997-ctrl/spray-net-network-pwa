...
The public catalog in `site/data/mailing.json` contains **127** source-reviewed records: 49 school/program locations; two district offices; 11 dental offices; nine veterinary clinics; four funeral-home locations; 11 private childcare locations; six churches; five wedding/event venues; eight medical offices; eight med spas; three standalone restaurants; three independent lodging prospects; and eight professional offices. The September 22 expansion adds 30 addresses across the five newest categories. Recipient notes flag suites, appointment requirements and restricted access without claiming verified property ownership. Notes remain in saved export snapshots and backups but are excluded from the eight-column postal export. Research and excluded prospects are documented in [the September 22 research log](docs/mailing-expansion-2026-09-22.md). The September 21 expansion adds 35 prospects across Fort Mill, Rock Hill, Indian Land, Lake Wylie (Clover mailing address), Belmont, Gastonia, Charlotte, Waxhaw and Weddington. Every address has an official source URL and review date; explicit mailing PO boxes are retained. This is starter coverage, not a complete territory list. Building ownership, exterior approval authority, surface condition, coating suitability and postal deliverability remain unverified. School sources are the [Fort Mill directory](https://www.fortmillschools.org/about-us/our-schools-directory) and [Rock Hill directory](https://www.rock-hill.k12.sc.us/district/our-schools); other sources are official organization pages linked per record. Existing networking companies appear as held records until structured mailing addresses are researched. Categories can be combined in saved filters, Excel/CSV exports and sent-mail tracking. Existing recipient IDs and default dentist + school filters remain unchanged.
